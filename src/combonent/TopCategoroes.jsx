...
function TopCategoroes() {
  ...
  <div className="text ">
    <p className="text-center mt-4">
      Stay at the forefront of technological advancements with our comprehensive
      rangeof courses in technology <br />
      and IT. From coding and programming languages to cybersecurity and data
      science, our expert-led courses <br />
      ensure you're equipped with the skills demanded by the rapidly evolving
      digital landscape.
    </p>
  </div>
  <div className="cards ">
